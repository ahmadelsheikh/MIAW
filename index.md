...
<script type='text/javascript'>
	...
	var initESW = function(gslbBaseURL) {
		...
		embedded_svc.init(
			...
			'https://psa-bank.my.salesforce.com',

			'https://myfinance.stellantis-financial-services.de/deutschland',
	...
	if (!window.embedded_svc) {
		...
		s.setAttribute('src', 'https://psa-bank.my.salesforce.com/embeddedservice/5.0/esw.min.js');
